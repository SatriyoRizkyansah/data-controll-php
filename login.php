...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="input">
        <h3 class="text-primary text-center p-2">LOGIN</h3>
      ...
      <div class="footer p-3 text-center bg-primary">
        <span class="color-white"
          >You don't have an account? <a href="registrasi.php" style="text-decoration: none; color: white"> <i class="bi bi-person-add"> registrasi!</i></a></span
        >
      </div>
    </div>
